...
# Created by write_sdc on Thu Feb 23 03:02:10 2023
...
set_clock_uncertainty -setup 8.3  [get_clocks W_CLK]
set_clock_uncertainty -hold 0.7  [get_clocks W_CLK]
create_clock [get_ports R_CLK]  -period 20  -waveform {0 10}
set_clock_latency -max 12  [get_clocks R_CLK]
set_clock_uncertainty -setup 8.3  [get_clocks R_CLK]
set_clock_uncertainty -hold 0.7  [get_clocks R_CLK]
